...
**sanathboddhula** · [← Back to profile](../README.md) · Updated 2026-08-26
...
|---|---|---|---|---|
| Write your first C program, trace the four-stage gcc compilation pipeline (preprocess/compile/assemble/link), and understand why C produces tiny, fast native binaries. | ⬜ Not started | ❌ Failed | 2026-08-26 | [→](https://github.com/techmonster-dev-org/tm-student-sanathboddhula-c-systems/issues/1) |
...
| Explore C's fundamental types, use sizeof and <limits.h> to inspect platform sizes and bounds, use <stdint.h> fixed-width types, and understand why signed overflow is undefined behavior while unsigned wraparound is not. | ⬜ Not started | ❌ Failed | 2026-08-26 | [→](https://github.com/techmonster-dev-org/tm-student-sanathboddhula-c-systems/issues/2) |
